...
Output : The sign is - */
/******* Start Your Code *********/
let num3 = window.prompt("Enter a number Product  : ");
let num4 = window.prompt("Enter a number Product  : ");
let num5 = window.prompt("Enter a number Product : ");
...
Output : 4, 0, -1 */
/******* Start Your Code *********/
let num6 = window.prompt("please enter the first number :: ");
let num7 = window.prompt("please enter the secound number ::");
let num8 = window.prompt("please enter the third number :: ");

if (num6 > num7 && num6 > num8) {
    if (num7 > num8) {
        alert("sort three numbers ::" + num6 + " " + num7 + " " + num8);
    } else {
        alert("sort three numbers ::" + num6 + " " + num8 + " " + num7);
    }
} else if (num7 > num6 && num7 > num8) {
    if (num6 > num8) {
        alert("sort three numbers ::" + num7 + " " + num6 + " " + num8);
    } else {
        alert("sort three numbers ::" + num7 + " " + num8 + " " + num6);
    }
} else if (num8 > num6 && num8 > num7) {
    if (num7 > num6) {
        alert("sort three numbers ::" + num8 + " " + num7 + " " + num6);
    } else {
        alert("sort three numbers ::" + num8 + " " + num6 + " " + num7);
    }
}
